      ...
      <div className="sm:pt-8 pt-8">
        ...
        <div className=" flex flex-col gap-2 pt-2">
                ...
                className={`w-full rounded-large ${
                  pathname === '/' ? 'bg-[#28292D]' : 'bg-[#000] hover:bg-[rgb(25,23,29)]'
          ...
          <Button
            ...
            className={`w-full  rounded-large 
               ${pathname === '/favorites' ? 'bg-[#28292D]' : 'bg-[#000] hover:bg-[rgb(25,23,29)]'}
          ...
          {user && (
            <Button
              ...
              className={`w-full  
                rounded-large ${pathname === '/my-orders' ? 'bg-[#28292D]' : 'bg-[#000] hover:bg-[rgb(25,23,29)]'}
                 flex justify-start pl-3 py-6 text-default-600 `}
            >
          ...
          <Button
            ...
            className={`w-full rounded-large 
             ${pathname === '/setings' ? 'bg-[#28292D]' : 'bg-[#000] hover:bg-[rgb(25,23,29)]'}
             flex justify-start pl-3 py-6 text-default-600 `}
          >
